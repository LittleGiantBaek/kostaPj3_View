...
<link rel="stylesheet" href="${pageContext.request.contextPath}/lib/css/optionSelect.css?v=1">
	...
	<script>
        ...
        var optionDivPosition = parseInt($(".col-btn").css("bottom"))
		    $(window).scroll(function() { 
		            ...
		            if(positionMin > 0){
		            	$(".div-map").stop().animate({"top":positionMin},500); 
		            }else{
		            	$(".div-map").stop().animate({"top":0},500); 
		            }
		    });
		});
	</script>
